...
2. Student information modification (according to student ID)  
3. Student information query
4. Count the total number of students and displaying all details.
5. Insert marks into the individual student ID
6. Showing the result of the students
5. Exit the system  
